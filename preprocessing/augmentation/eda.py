"""
Functions for easy data augmentation techniques for text classification.
This module is copied basically verbatim from the original authors by Jason Wei and Kai Zou.
